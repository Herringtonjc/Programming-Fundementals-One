...
int main()
{
    ...
    ofstream outfile("arrayOutput.txt");
    ...
    for(int i = 0; i < arraySize; i++)
    {
        ...
        outfile << a[i] << " "; //Output all array values
    }
    //Output the size of the array and the string being used to populate the array
    outfile << "\n\n";
    outfile << "The size of the dynamically allocated array: " << arraySize << "\n"
    << "The string being used for the dynamically allocated array: \n\n" << arrayString;
